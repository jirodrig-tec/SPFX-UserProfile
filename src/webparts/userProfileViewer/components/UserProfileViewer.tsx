    ...
    this.dataCenterServiceInstance.getUserProfileProperties().then((userProfileItems: IUserProfile) => {
      for (let i: number = 0; i < userProfileItems.UserProfileProperties.length; i++) {
        ...
        if (userProfileItems.UserProfileProperties[i].Key == "Title") {
          userProfileItems.Title = userProfileItems.UserProfileProperties[i].Value;
        }
        ...
        <div className={ styles.container }>
          <div className={ styles.row }>
            <div className={ styles.column }>
              <span className={ styles.title }>SPFx Iván - Welcome to SharePoint!</span>
              ...
              <p>
                Title: {this.state.userProfileItems.Title}
              </p>
